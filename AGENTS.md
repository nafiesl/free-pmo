...
- `git commit` with author: `env GIT_AUTHOR_NAME="OpenCode" git commit -m "..."`
- Translations are in Indonesian. Add keys to `lang/id/{domain}.php`.
- Run tests before committing (focused suite only, not full `php vendor/bin/phpunit`).
